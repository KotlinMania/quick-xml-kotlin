...
public sealed class IllFormedError : Exception() {
    ...
    public data class MissingEndTag(
    ...
    public data class UnmatchedEndTag(
        public val name: String,
    ) : IllFormedError() {
    ...
    public data class MismatchedEndTag(
...
public sealed class XmlException(
    ...
    public class Syntax(
        public val error: SyntaxError,
    ) : XmlException("syntax error: ${error.message}", error)

    public class IllFormed(
        public val error: IllFormedError,
    ) : XmlException("ill-formed document: ${error.message}", error)

    public class InvalidAttr(
        public val error: AttrError,
    ...
    public class Namespace(
        public val error: NamespaceError,
