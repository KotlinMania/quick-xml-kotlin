...
kotlin {
    ...
    val xcf = XCFramework("QuickXml")

    macosArm64 {
        binaries.framework { baseName = "QuickXml"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "QuickXml"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "QuickXml"
        flattenPackage = "io.github.kotlinmania.quickxml"
    }

    android {
        namespace = "io.github.kotlinmania.quickxml"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "quick-xml-kotlin", version.toString())

    pom {
        name.set("quick-xml-kotlin")
        description.set("Kotlin Multiplatform port of tafia/quick-xml - High performance xml reader and writer")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/quick-xml-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/quick-xml-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/quick-xml-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/quick-xml-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleQuickXmlXCFramework",
    "assembleQuickXmlDebugXCFramework",
    "assembleQuickXmlReleaseXCFramework",
    "assembleDebugIosFatFrameworkForQuickXmlXCFramework",
    "assembleReleaseIosFatFrameworkForQuickXmlXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForQuickXmlXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForQuickXmlXCFramework",
    "assembleDebugMacosFatFrameworkForQuickXmlXCFramework",
    "assembleReleaseMacosFatFrameworkForQuickXmlXCFramework",
    "assembleDebugTvosFatFrameworkForQuickXmlXCFramework",
    "assembleReleaseTvosFatFrameworkForQuickXmlXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForQuickXmlXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForQuickXmlXCFramework",
    "assembleDebugWatchosFatFrameworkForQuickXmlXCFramework",
    "assembleReleaseWatchosFatFrameworkForQuickXmlXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForQuickXmlXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForQuickXmlXCFramework",
