...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `QuickXml.swiftmodule/`
...
//      `import QuickXml` above would fail at compile time.
//
//   2. The static archive `libQuickXml.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "QuickXml" }` and
//      `flattenPackage = "io.github.kotlinmania.quickxml"` configuration in
...
//      via the `QuickXmlLibrary` product.
//
...
final class QuickXmlExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "QuickXml swift module imported cleanly")
    }
}
