...
This file is the quick-reference operating contract for quick-xml-kotlin. The longer
...
quick-xml-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`quick-xml`](https://crates.io/crates/quick-xml). Upstream Rust is the behavioral oracle while the
